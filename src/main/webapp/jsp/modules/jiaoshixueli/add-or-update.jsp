		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑教师学历</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>教师学历管理</span></li>
								<li class="breadcrumb-item active"><span>编辑教师学历</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">教师学历信息</h3>
								...
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										...
										<select id="xueliSelect" name="xueli" class="form-control">
												<option value=""></option>
												<option class="xueliOption" value="硕士">
													硕士
												</option>
												<option class="xueliOption" value="本科">
													本科
												</option>
												<option class="xueliOption" value="专科">
													专科
												</option>
										</select>	
									</div>	
									...
									<div class="form-group col-md-6">
										<label>毕业时间</label>
										<div id="biyeshijianDate" class="input-append date form_datetime">
											<input id="biyeshijian-input" name="biyeshijian" size="15" type="text" readonly>
									...
									<div class="form-group col-md-6">
										<label>毕业学校</label>
										<input name="biyexuexiao" id="biyexuexiao" name="biyexuexiao" class="form-control" placeholder="毕业学校">
									</div>
									<div class="form-group col-md-6">
										<label>学校类型</label>
										<input name="xuexiaoleixing" id="xuexiaoleixing" name="xuexiaoleixing" class="form-control" placeholder="学校类型">
									</div>
									<div class="form-group col-md-6">
										<label>外语等级</label>
										<input name="waiyudengji" id="waiyudengji" name="waiyudengji" class="form-control" placeholder="外语等级">
									</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "jiaoshixueli/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("jiaoshixueli/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("jiaoshixueli/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("jiaoshixueli/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#biyeshijianDate").datetimepicker({ 
				minView: "month",
				autoclose: true,
				format:'yyyy-mm-dd',
				language:'zh-CN',
		...
		function dataBind(){
			...
			$("#biyeshijian-input").val(ruleForm.biyeshijian);
			$("#biyexuexiao").val(ruleForm.biyexuexiao);	
			$("#xuexiaoleixing").val(ruleForm.xuexiaoleixing);	
			$("#waiyudengji").val(ruleForm.waiyudengji);	
		}		
		//图片显示
		function showImg(){
		}		
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.biyeshijian != null && res.data.biyeshijian != ''){

						$("#biyeshijian-input").val(res.data.biyeshijian);
						$('#biyeshijianFileName').val(res.data.biyeshijian)
					}
					if(res.data != null && res.data != '' && res.data.biyexuexiao != null && res.data.biyexuexiao != ''){

						$("#biyexuexiao").val(res.data.biyexuexiao);
						$("#biyexuexiao").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.xuexiaoleixing != null && res.data.xuexiaoleixing != ''){

						$("#xuexiaoleixing").val(res.data.xuexiaoleixing);
						$("#xuexiaoleixing").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.waiyudengji != null && res.data.waiyudengji != ''){

						$("#waiyudengji").val(res.data.waiyudengji);
						$("#waiyudengji").attr('readonly','readonly');
					}
				}
			});  
            }
