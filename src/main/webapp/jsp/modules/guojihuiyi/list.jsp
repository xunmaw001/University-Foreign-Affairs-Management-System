...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">国际会议管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>国际会议列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">国际会议列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										会议标题
									</label>
									<input type="text" id="huiyibiaotiSearch" class="form-control form-control-sm" placeholder="请输入会议标题" aria-controls="tableId">
									<label>
										教师姓名
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('huiyibiaoti')">会议标题<i id="huiyibiaotiIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('huiyijianjie')">会议简介<i id="huiyijianjieIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('huiyishijian')">会议时间<i id="huiyishijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#huiyibiaotiSearch').val() != null && $('#huiyibiaotiSearch').val() != ''){
				searchForm.huiyibiaoti ="%" +  $('#huiyibiaotiSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("guojihuiyi/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				huiyibiaoti : searchForm.huiyibiaoti,	
		...
		function setDataRow(item,number){
			...
			var huiyibiaotiCell  = document.createElement('td');

						 huiyibiaotiCell.innerHTML = item.huiyibiaoti;

			row.appendChild(huiyibiaotiCell);
			var huiyijianjieCell  = document.createElement('td');

						 huiyijianjieCell.innerHTML = item.huiyijianjie;

			row.appendChild(huiyijianjieCell);
			var huiyineirongCell  = document.createElement('td');

			
			var huiyishijianCell  = document.createElement('td');

						  huiyishijianCell.innerHTML = item.huiyishijian;


			row.appendChild(huiyishijianCell);
		...
		function sh(){
			...
			httpJson("guojihuiyi/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("guojihuiyi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"guojihuiyi");
