...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="yuanxiSearch" class="form-control form-control-sm" placeholder="请输入院系" aria-controls="tableId">
	...
	<script>
		...
		function search(){
			...
			if($('#yuanxiSearch').val() != null && $('#yuanxiSearch').val() != ''){
				searchForm.yuanxi ="%" +  $('#yuanxiSearch').val() + "%";
			}
