...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑外事信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑外事信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">外事信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>证照号码</label>
										<input id="zhengzhaohaoma" name="zhengzhaohaoma" class="form-control" value="" readonly>
									</div>
									<div class="form-group col-md-6">
										<label>有效期</label>
										<div id="youxiaoqiDate" class="input-append date form_datetime">
											<input id="youxiaoqi-input" name="youxiaoqi" size="15" type="text" readonly>
									...
									<div class="form-group col-md-6">
										<label>签证信息</label>
										<textarea  name="qianzhengxinxi" class="form-control" id="qianzhengxinxi" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>教师工号</label>
	...
	<script>
		...
		function zhengzhaohaomaUuid(){
			if($("#zhengzhaohaoma").val() == null || $("#zhengzhaohaoma").val() == "null" || $("#zhengzhaohaoma").val() == ""){
				$("#zhengzhaohaoma").attr("value",Math.round(new Date().getTime()/1000));
			}
		}				
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "waishixinxi/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("waishixinxi/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("waishixinxi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("waishixinxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#youxiaoqi-input").val(ruleForm.youxiaoqi);
			$("#qianzhengxinxi").val(ruleForm.qianzhengxinxi);
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.youxiaoqi != null && res.data.youxiaoqi != ''){
						...
						$("#youxiaoqi-input").val(res.data.youxiaoqi);
						$('#youxiaoqiFileName').val(res.data.youxiaoqi)
					}
					if(res.data != null && res.data != '' && res.data.qianzhengxinxi != null && res.data.qianzhengxinxi != ''){

						$("#qianzhengxinxi").val(res.data.qianzhengxinxi);
					}
