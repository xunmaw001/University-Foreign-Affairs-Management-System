...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">学分核定管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>学分核定列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">学分核定列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('shenqingxuefen')">申请学分<i id="shenqingxuefenIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('huixiaoshijian')">回校时间<i id="huixiaoshijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var shenqingxuefenCell  = document.createElement('td');

						 shenqingxuefenCell.innerHTML = item.shenqingxuefen;

			row.appendChild(shenqingxuefenCell);
			var xuexiqingkuangCell  = document.createElement('td');

			
			var huixiaoshijianCell  = document.createElement('td');

						  huixiaoshijianCell.innerHTML = item.huixiaoshijian;


			row.appendChild(huixiaoshijianCell);
		...
		function sh(){
			...
			httpJson("xuefenheding/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("xuefenheding/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"xuefenheding");
