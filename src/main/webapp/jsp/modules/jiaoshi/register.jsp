...
<style>
	...
	body {
		...
		width: 100%;
		height: 100%;
						background-image: url(http://codegen.caihongy.cn/20220124/14b46bc1aa49415486f6cecf3e0b74e6.png) !important;
					}
	.container {
		padding: 0;
		margin: 0;
	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<input  name="bumen" placeholder="部门" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">职务</label> 
							<input  name="zhiwu" placeholder="职务" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<input  name="jiguan" placeholder="籍贯" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">民族</label> 
							<input  name="minzu" placeholder="民族" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">政治面貌</label> 
							<input  name="zhengzhimianmao" placeholder="政治面貌" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">家庭住址</label> 
							<input  name="jiatingzhuzhi" placeholder="家庭住址" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">联系电话</label> 
							<input  name="lianxidianhua" placeholder="联系电话" class="form-control-i">
							</div>
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "jiaoshi/register";
				$.ajax({ 
					type: "POST",
					url: url,
