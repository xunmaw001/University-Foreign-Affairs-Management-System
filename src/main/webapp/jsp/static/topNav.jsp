<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<style>
		...
		.top-brand .nav .dropdown-menu.profile::before {
			left: 100%;
			margin-left: -28px;
			border-bottom-color: rgba(135, 142, 224, 1);
		}
		...
		.top-brand .nav .dropdown-menu.profile h5 {
			...
			border-style: solid;
			border-color: #333;
			background-color: rgba(135, 142, 224, 1);
			box-shadow: 0 0 0px #878EE0;
			text-align: center;
		}
				...
				<div class="container top-brand" style="display: flex;">
					...
					<nav class="navbar navbar-default">			
						<div class="navbar-header">
							<a href="${pageContext.request.contextPath}/index.jsp">高校外事管理系统</a>
						</div>
